...
const DIRECTIONAL_ICON_SIZE = 30;
        ...
        <div className="game-controls glass-panel">
            {showDirectionalPad ? (
                <div className="control-dpad">
                    ...
                    >
                        <ArrowUp size={DIRECTIONAL_ICON_SIZE} strokeWidth={2.8} />
                    </button>
                    ...
                    <div className="control-dpad-middle">
                        <button type="button" onClick={onLeft} className="control-btn control-pad-btn control-square-btn">
                            <ArrowLeft size={DIRECTIONAL_ICON_SIZE} strokeWidth={2.8} />
                        </button>
                        <button
                            type="button"
                            onClick={onDown}
                        ...
                        >
                            <ArrowDown size={DIRECTIONAL_ICON_SIZE} strokeWidth={2.8} />
                        </button>
                        <button type="button" onClick={onRight} className="control-btn control-pad-btn control-square-btn">
                            <ArrowRight size={DIRECTIONAL_ICON_SIZE} strokeWidth={2.8} />
                        </button>
                    </div>
                </div>
            ) : (
